...
MainLoop:	
	...
	BNE.S	.skip
	MOVE.W	#0,NOISE_IDX5	; show rastertime left down to $12c
	.skip:
	...
	LEA	NOISE_IDX3,A2
	LEA	PLANE_3,A0
	MOVE.W	#bypl+18,D1		; OFFSET
	MOVE.W	#bypl/2+4,D2		; SUBSTR
...
BLUE_COLS:	DC.W $032D,$032F,$010E,$020D,$012E,$031C,$000D,$001E
		DC.W $000F,$022E,$030F,$012F,$032C,$000E,$022D,$051C
		DC.W $031E,$023F,$053C,$047B,$030D,$030E,$033D,$023E
