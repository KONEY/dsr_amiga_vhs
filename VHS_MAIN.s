;*** dSr AMIGA VHS *** CODE/GFX/MUSIC: KONEY ***
;        __________
...
DYNCOPPER		EQU 1
	IFNE DYNCOPPER
COP_WAITS		EQU 240+1+1+1
COP_FRAMES	EQU 32
COP_WAITS_SIZE	EQU COP_WAITS*(4+4)
COP_SIZE_DIFF	EQU 4+4+4+4+4+4+8+8+4+4+4+4+4+4+4
	ENDC
...
Demo:			;a4=VBR, a6=Custom Registers Base addr
	...
	MOVE.L	#$0011001B,D2	; ENDING WAITS
	.loop2:
	MOVE.L	A1,(A4)+
...
BlitterFill:
	...
	MOVE.L	A4,BLTDPTH
	MOVE.W	#he/6/3*64+wi*2/16,BLTSIZE	; Start Blitter (Blitsize)
	RTS
...
__BLK_GENERIC2:
	...
	CMP.W	#$1C,D0
	BGE.W	__BLK_STROBE2
	LEA	PREFILLED_COLORS_GREEN2,A6
	RTS
...
__BLK_SYNTH:
	...
	BEQ.W	__BLK_BLUE0
	CMP.W	#$3,D0
	BLO.S	__BLK_NEXT_COLOR
	CMP.W	#$6,D0
	BLO.S	__BLK_PREV_COLOR
	CMP.W	#$34,D0
	BGE.W	__BLK_STROBE2
	BRA.W	__BLK_BLUE_GRAY0
...
__BLK_BUILDUP:
	CMP.W	#$1C,D0
	BLO.W	__BLK_STROBE0
	;MOVE.L	#$0001,SCANLINE_IDX0
	;MOVE.L	#$0000,SCANLINE_IDX2
	MOVE.B	SCANLINE_IDX4+1,BPL1MOD
	;MOVE.B	SCANLINE_IDX6+1,BPL2MOD
	BRA.W	__BLK_STROBE3

__BLK_MODS:
	TST.B	FRAME_STROBE
	BNE.S	.skip
	MOVE.B	SCANLINE_IDX5+1,BPL1MOD
	RTS
	.skip:
	MOVE.B	SCANLINE_IDX6+1,BPL2MOD
	RTS
...
__BLK_GREEN1:
	LEA	PREFILLED_COLORS_GREEN1,A6
	RTS
...
__BLK_MIX2:
	LEA	PREFILLED_COLORS_MIX2,A6
	RTS

__BLK_GRAY1:
	LEA	PREFILLED_COLORS_GRAY1,A6
	RTS

__BLK_GRAY2:
	LEA	PREFILLED_COLORS_GRAY2,A6
	RTS
...
__DECRUNCH_COPPERLIST:
	...
	CMP.W	#$E1,D0		; 12.032 - #$2F00
	BNE.S	.dontRecolorNoise3
	MOVE.W	#$0194,(A1)+	; RECOLOR NOISE
	MOVE.W	#$0DDD,(A1)+	; RECOLOR NOISE
	.dontRecolorNoise3:

	CMP.W	#$E5,D0		; 12.032 - #$2F00
	BNE.S	.dontRecolorNoise1
	MOVE.W	#$0194,(A1)+	; RECOLOR NOISE
	MOVE.W	#$0334,(A1)+	; RECOLOR NOISE
	.dontRecolorNoise1:

	CMP.W	#$F4,D0		; 12.032 - #$2F00
	BNE.S	.dontRecolorNoise2
	MOVE.W	#$0194,(A1)+	; RECOLOR NOISE
	MOVE.W	#$0BBC,(A1)+	; RECOLOR NOISE
	.dontRecolorNoise2:

	CMP.W	#$F,D0		; 12.032 - #$2F00
	BNE.S	.dontRecolorNoise0
	MOVE.W	#$0194,(A1)+	; RECOLOR NOISE
	MOVE.W	#$0445,(A1)+	; RECOLOR NOISE
	MOVE.W	#$0198,(A1)+	; RECOLOR NOISE
	MOVE.W	#$0CCB,(A1)+	; RECOLOR NOISE
	.dontRecolorNoise0:

	CMP.W	D2,D0		; 12.032 - #$2F00
	BNE.S	.dontRecolorNoise4
	MOVE.W	#$0194,(A1)+	; RECOLOR NOISE
	MOVE.W	#$0334,(A1)+	; RECOLOR NOISE
	MOVE.W	#$0198,(A1)+	; RECOLOR NOISE
	MOVE.W	#$0004,(A1)+	; RECOLOR NOISE
	.dontRecolorNoise4:

	CMP.W	#$FF,D0		; ZEROED WORD = allow VPOS>$ff
	BNE.S	.notFF
	MOVE.W	#$0,D0
	MOVE.L	#$FFDFFFFE,-4(A1)	; allow VPOS>$ff
	.notFF:
...
__FILLSOLID:
	...
	CMP.W	#$A000,D5
	BNE.S	.noNoiseLine
	MOVE.W	D5,$DFF180	; SHOW ACTIVITY
	EOR.L	#$1FF,D5
	NOT.L	D5
	MOVE.L	D5,D0
	.noNoiseLine:
...
V_IDX1:		DC.W $2
V_IDX2:		DC.W $32
V_OFFSET:		DC.W 0,40,40,80,80,40,40,0,0,-40,-80,-84,-40,-40,0;,-2
		DC.W 40,40,80,80,40,0,-40,-40,-80,-80,-40,-42,-40,4,2,0,-4
...
TXT_BODY:		DC.B " PLEASE INSERT A CASSETTE  "
		DC.B "  ** *** AMIGA VHS *** **  "
		DC.B "    40 KB AMIGA INTRO      "
		DC.B "  PRESENTED BY DES$RE AT   "
		DC.B "     68K INSIDE - 2024     "
		...
		DC.B " EMULATION IS LAST RESORT  "
		DC.B " FOR SENILE NOSTALGIC...   "
		DC.B " REAL HARDWARE IS MINIMUM  "
		DC.B "  REQ. FOR A COMMITTED     "
		DC.B "  AMIGA WORSHIPPER!!! :)   "
		DC.B " ------------------------  "
		DC.B " TIME TO SHOUT OUT GREETZ  "
		DC.B "    TO ALL DSR MEMBERS     "
		DC.B "    AND FRIENDS AND TO     "
		DC.B "  THE 68K INSIDE CROWD!!!  "
		DC.B " NO MORE BYTES FOR TXT SO  "
		DC.B " REWIND...                 "
		DC.W $0
TXT_FOOTER:	DC.B " TRACKING                  ",$0		;EVEN
TXT_TIMELINE_IDX:	DC.W $0
TXT_TIMELINE:	DC.L __SCROLL_FOOTER
		DC.L __SWAP_HEADER_TEXT,__NOP\.nOP,__NOP\.nOP,__NOP\.nOP
		DC.L __SCROLL_FOOTER,__NOP,__NOP,__NOP,__NOP
		DC.L __SCROLL_FOOTER,__NOP,__NOP,__NOP,__NOP
		DC.L __SCROLL_FOOTER,__NOP,__NOP,__NOP,__NOP
		DC.L __NOP,__NOP
...
V_LINE_IDX:	DC.B 0,0
SCANLINE_IDX0:	DC.W $00
SCANLINE_IDX1:	DC.W $00
SCANLINE_IDX2:	DC.W $00
SCANLINE_IDX3:	DC.W $00
...
COPPER:	; #### COPPERLIST ####################################################
	...
	DC.W $0190,$0AAA,$0194,$0333,$0198,$0666,$019C,$0888
	...
	;DC.W $104,%0000000000000000	; BPLCON2
