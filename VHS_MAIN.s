...
Demo:			;a4=VBR, a6=Custom Registers Base addr
	...
	BSR.W	PokePtrs
	LEA	PLANE1,A0	; PF_2 NOIZE (FILLED)
...
MainLoop:
	...
	ADD.B	#$8,SCANLINE_IDX1
	ADD.B	#$7,SCANLINE_IDX2
	ADD.B	#$8,SCANLINE_IDX3
	SUB.B	#$2,SCANLINE_IDX0
	ADD.B	#$7,SCANLINE_IDX4
	ADD.B	#$6,SCANLINE_IDX5
	ADD.B	#$6,SCANLINE_IDX6
...
MIX_COLS1:	DC.W $000C,$000D,$000A,$000B		; BLU3
		...
		DC.W $0204,$0205,$0104,$0205		; PURPL
		DC.W $0026,$002A,$0028,$002F		; BLU2
		DC.W $004C,$004E,$004F,$015F		; cyan
		DC.W $0042,$0053,$0051,$0042		; GREEN
		DC.W $004C,$004E,$004F,$015F		; cyan
		...
		DC.W $0121,$0010,$0030,$0040		; green4
		DC.W $000C,$000E,$000F,$001B		; BLU3
		DC.W $0028,$002A,$002F,$0026		; BLU2
		DC.W $001D,$040D,$030B,$030D		; PURPL
		DC.W $0242,$0044,$0043,$0042		; green new
		DC.W $011E,$011D,$011C,$010E		; BLU?
		DC.W $000C,$000E,$000F,$001B		; BLU3
		DC.W $0138,$013C,$0137,$013A		; blu2
...
V_LINE_IDX:	DC.B $FF
SCANLINE_IDX0:	DC.B $30	; GOES BACK
SCANLINE_IDX1:	DC.B $50
SCANLINE_IDX2:	DC.B $60
SCANLINE_IDX3:	DC.B $70	; WHEN MEETS 0 1&2 ARE ENTAGLED
SCANLINE_IDX4:	DC.B $80
SCANLINE_IDX5:	DC.B $0	; ENTANGLED
SCANLINE_IDX6:	DC.B $3	; ENTANGLED
